...
const en = {
  ...
  trust: {
    ratingTitle: "Rated 4.9/5",
    ratingText: "12,000+ travellers",
    expertsTitle: "Local experts",
    expertsText: "Handpicked experiences",
    secureTitle: "Secure booking",
    secureText: "Protected payments",
    flexibleTitle: "Flexible cancellation",
    flexibleText: "Book with confidence",
  },
  search: {
...
const es: Dictionary = {
  ...
  trust: {
    ratingTitle: "Valorado 4,9/5",
    ratingText: "Más de 12.000 viajeros",
    expertsTitle: "Expertos locales",
    expertsText: "Experiencias seleccionadas",
    secureTitle: "Reserva segura",
    secureText: "Pagos protegidos",
    flexibleTitle: "Cancelación flexible",
    flexibleText: "Reserva con confianza",
  },
  search: {
...
const pt: Dictionary = {
  ...
  trust: {
    ratingTitle: "Avaliado 4,9/5",
    ratingText: "Mais de 12.000 viajantes",
    expertsTitle: "Especialistas locais",
    expertsText: "Experiências selecionadas",
    secureTitle: "Reserva segura",
    secureText: "Pagamentos protegidos",
    flexibleTitle: "Cancelamento flexível",
    flexibleText: "Reserve com confiança",
  },
  search: {
...
const it: Dictionary = {
  ...
  trust: {
    ratingTitle: "Valutato 4,9/5",
    ratingText: "Oltre 12.000 viaggiatori",
    expertsTitle: "Esperti locali",
    expertsText: "Esperienze selezionate",
    secureTitle: "Prenotazione sicura",
    secureText: "Pagamenti protetti",
    flexibleTitle: "Cancellazione flessibile",
    flexibleText: "Prenota in tutta serenità",
  },
  search: {
