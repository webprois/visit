...
const en = {
  ...
  booking: {
    ...
    promoApply: "Apply",
    promoInvalid: "This discount code isn't valid for this booking.",
  ...
  emailLockedHint: "This is your account email. Your booking will appear in My Trips.",
  ...
  weather: {
    title: "Weather & Northern Lights",
    intro:
      "Iceland's weather changes fast — check the outlook for the areas you're visiting, and see tonight's aurora conditions before you head out.",
    auroraTitle: "Northern lights tonight",
    kpLabel: "Activity (Kp)",
    ...
    levelFair: "Fair",
    levelLow: "Low",
    levelExcellentText: "Strong activity and clear skies — a night to be out hunting.",
    levelGoodText: "Good chances tonight if you find a break in the clouds.",
    levelFairText: "Some activity expected — worth watching the sky.",
    levelLowText: "Quiet night — activity or visibility is limited.",
    outOfSeason:
      "Iceland's summer nights are too bright for the northern lights. The aurora season runs from late August to mid-April — book ahead for the dark months!",
    auroraUnavailable: "Aurora forecast is temporarily unavailable.",
    forecastTitle: "7-day forecast around Iceland",
    forecastIntro:
      "Highs and lows, wind and chance of precipitation for the regions our tours visit. All times are local Icelandic time.",
    forecastUnavailable: "Forecast temporarily unavailable for this area.",
    windUnit: "m/s",
    precipShort: "precip.",
    locations: {
      reykjavik: "Reykjavík",
      goldenCircle: "Golden Circle",
      southCoast: "South Coast (Vík)",
      jokulsarlon: "Jökulsárlón",
      snaefellsnes: "Snæfellsnes",
      akureyri: "Akureyri (North)",
    },
    conditions: {
      clear: "Clear",
    ...
    linksTitle: "Before you travel",
    linksIntro: "Official Icelandic sources for conditions and safe travel:",
    linkSafetravel: "Alerts and travel safety from Icelandic Search and Rescue.",
    linkRoad: "Live road conditions from the Road Administration.",
    linkVedur: "The Icelandic Met Office's official forecast.",
    sourcesNote: "Weather data from Open-Meteo · Aurora activity from NOAA SWPC",
    browseTours: "Browse our tours",
  },
}
...
const es: Dictionary = {
  ...
  booking: {
    ...
    promoApply: "Aplicar",
    promoInvalid: "Este código de descuento no es válido para esta reserva.",
  ...
  emailLockedHint: "Este es el correo de tu cuenta. Tu reserva aparecerá en Mis viajes.",
  ...
  weather: {
    title: "El tiempo y auroras boreales",
    intro:
      "El tiempo en Islandia cambia rápido: consulta la previsión de las zonas que vas a visitar y las condiciones de auroras de esta noche antes de salir.",
    auroraTitle: "Auroras boreales esta noche",
    kpLabel: "Actividad (Kp)",
    cloudLabel: "Nubosidad",
    levelExcellent: "Excelente",
    levelGood: "Buena",
    levelFair: "Moderada",
    levelLow: "Baja",
    levelExcellentText: "Actividad fuerte y cielos despejados: una noche para salir a buscarlas.",
    levelGoodText: "Buenas posibilidades esta noche si encuentras un claro entre las nubes.",
    levelFairText: "Se espera algo de actividad: vale la pena mirar al cielo.",
    levelLowText: "Noche tranquila: la actividad o la visibilidad es limitada.",
    outOfSeason:
      "Las noches de verano en Islandia son demasiado claras para ver auroras. La temporada va de finales de agosto a mediados de abril. ¡Reserva con antelación para los meses oscuros!",
    auroraUnavailable: "La previsión de auroras no está disponible temporalmente.",
    forecastTitle: "Previsión de 7 días en Islandia",
    forecastIntro:
      "Máximas y mínimas, viento y probabilidad de precipitación en las regiones que visitan nuestros tours. Todas las horas son locales de Islandia.",
    forecastUnavailable: "Previsión no disponible temporalmente para esta zona.",
    windUnit: "m/s",
    precipShort: "precip.",
    locations: {
      reykjavik: "Reikiavik",
      goldenCircle: "Círculo Dorado",
      southCoast: "Costa Sur (Vík)",
      jokulsarlon: "Jökulsárlón",
      snaefellsnes: "Snæfellsnes",
      akureyri: "Akureyri (Norte)",
    },
    conditions: {
      clear: "Despejado",
    ...
    linksTitle: "Antes de viajar",
    linksIntro: "Fuentes oficiales islandesas sobre condiciones y seguridad:",
    linkSafetravel: "Alertas y seguridad de la asociación islandesa de rescate.",
    linkRoad: "Estado de las carreteras en tiempo real de la Administración de Carreteras.",
    linkVedur: "La previsión oficial del Instituto Meteorológico de Islandia.",
    sourcesNote: "Datos meteorológicos de Open-Meteo · Actividad de auroras de NOAA SWPC",
    browseTours: "Ver nuestros tours",
  },
}
...
const pt: Dictionary = {
  ...
  booking: {
    ...
    promoApply: "Aplicar",
    promoInvalid: "Este código de desconto não é válido para esta reserva.",
  ...
  emailLockedHint: "Este é o email da sua conta. A sua reserva aparecerá em As minhas viagens.",
  ...
  weather: {
    title: "Meteorologia e auroras boreais",
    intro:
      "O tempo na Islândia muda depressa — consulte a previsão para as zonas que vai visitar e as condições de auroras desta noite antes de sair.",
    auroraTitle: "Auroras boreais esta noite",
    kpLabel: "Atividade (Kp)",
    cloudLabel: "Nebulosidade",
    levelExcellent: "Excelente",
    levelGood: "Boa",
    levelFair: "Moderada",
    levelLow: "Baixa",
    levelExcellentText: "Atividade forte e céu limpo — uma noite para sair à caça.",
    levelGoodText: "Boas hipóteses esta noite se encontrar uma aberta nas nuvens.",
    levelFairText: "Espera-se alguma atividade — vale a pena observar o céu.",
    levelLowText: "Noite calma — a atividade ou a visibilidade é limitada.",
    outOfSeason:
      "As noites de verão na Islândia são demasiado claras para ver auroras. A temporada vai do final de agosto a meados de abril — reserve com antecedência para os meses escuros!",
    auroraUnavailable: "A previsão de auroras está temporariamente indisponível.",
    forecastTitle: "Previsão de 7 dias pela Islândia",
    forecastIntro:
      "Máximas e mínimas, vento e probabilidade de precipitação nas regiões que os nossos tours visitam. Todas as horas são locais da Islândia.",
    forecastUnavailable: "Previsão temporariamente indisponível para esta zona.",
    windUnit: "m/s",
    precipShort: "precip.",
    locations: {
      reykjavik: "Reiquiavique",
      goldenCircle: "Círculo Dourado",
      southCoast: "Costa Sul (Vík)",
      jokulsarlon: "Jökulsárlón",
      snaefellsnes: "Snæfellsnes",
      akureyri: "Akureyri (Norte)",
    },
    ...
    linksTitle: "Antes de viajar",
    linksIntro: "Fontes oficiais islandesas sobre condições e segurança:",
    linkSafetravel: "Alertas e segurança da associação islandesa de busca e salvamento.",
    linkRoad: "Estado das estradas em tempo real da Administração Rodoviária.",
    linkVedur: "A previsão oficial do Instituto Meteorológico da Islândia.",
    sourcesNote: "Dados meteorológicos da Open-Meteo · Atividade de auroras da NOAA SWPC",
    browseTours: "Ver os nossos tours",
  },
  }
...
const it: Dictionary = {
  ...
  booking: {
    ...
    promoApply: "Applica",
    promoInvalid: "Questo codice sconto non è valido per questa prenotazione.",
  ...
  emailLockedHint: "Questa è l'email del tuo account. La tua prenotazione apparirà in I miei viaggi.",
  passwordLabel: "Password",
  ...
  weather: {
    title: "Meteo e aurora boreale",
    intro:
      "Il meteo in Islanda cambia in fretta: controlla le previsioni per le zone che visiterai e le condizioni dell'aurora di stanotte prima di uscire.",
    auroraTitle: "Aurora boreale stanotte",
    kpLabel: "Attività (Kp)",
    cloudLabel: "Copertura nuvolosa",
    levelExcellent: "Eccellente",
    levelGood: "Buona",
    levelFair: "Discreta",
    levelLow: "Bassa",
    levelExcellentText: "Attività intensa e cieli sereni: una notte da passare a caccia.",
    levelGoodText: "Buone probabilità stanotte se trovi uno squarcio tra le nuvole.",
    levelFairText: "È prevista un po' di attività: vale la pena guardare il cielo.",
    levelLowText: "Notte tranquilla: attività o visibilità limitata.",
    outOfSeason:
      "Le notti estive islandesi sono troppo luminose per l'aurora boreale. La stagione va da fine agosto a metà aprile: prenota in anticipo per i mesi bui!",
    auroraUnavailable: "Le previsioni dell'aurora non sono al momento disponibili.",
    forecastTitle: "Previsioni a 7 giorni in Islanda",
    forecastIntro:
      "Massime e minime, vento e probabilità di precipitazioni nelle regioni visitate dai nostri tour. Tutti gli orari sono locali islandesi.",
    forecastUnavailable: "Previsioni temporaneamente non disponibili per questa zona.",
    windUnit: "m/s",
    precipShort: "precip.",
    locations: {
      reykjavik: "Reykjavík",
      goldenCircle: "Circolo d'Oro",
      southCoast: "Costa Sud (Vík)",
      jokulsarlon: "Jökulsárlón",
      snaefellsnes: "Snæfellsnes",
      akureyri: "Akureyri (Nord)",
    },
    conditions: {
      clear: "Sereno",
    ...
    linksTitle: "Prima di partire",
    linksIntro: "Fonti ufficiali islandesi su condizioni e sicurezza:",
    linkSafetravel: "Allerte e sicurezza dall'associazione islandese di soccorso.",
    linkRoad: "Condizioni stradali in tempo reale dall'Amministrazione stradale.",
    linkVedur: "Le previsioni ufficiali dell'Istituto meteorologico islandese.",
    sourcesNote: "Dati meteo da Open-Meteo · Attività aurorale da NOAA SWPC",
    browseTours: "Scopri i nostri tour",
  },
  }
